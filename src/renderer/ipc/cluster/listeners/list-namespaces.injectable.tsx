...
const listener = ({ getClusterById, infoNotification, hasNotificationById }: Dependencies): ListNamespacesForbidden => (
  (clusterId) => {
...
const clusterListNamespacesForbiddenListenerInjectable = getInjectable({
  setup: (di) => {
    setupListener(di, emitListNamespacesForbiddenInjectionToken, listener({
      getClusterById: di.inject(getClusterByIdInjectable),
      hasNotificationById: di.inject(hasNotificationByIdInjectable),
